...
local MSA_DROPDOWNMENU_MINBUTTONS = 8;
local MSA_DROPDOWNMENU_MAXBUTTONS = 8;
local MSA_DROPDOWNMENU_MAXLEVELS = 2;
local MSA_DROPDOWNMENU_BUTTON_HEIGHT = 16;
local MSA_DROPDOWNMENU_BORDER_HEIGHT = 15;
-- The current open menu
local MSA_DROPDOWNMENU_OPEN_MENU = nil;
-- The current menu being initialized
local MSA_DROPDOWNMENU_INIT_MENU = nil;
-- Current level shown of the open menu
local MSA_DROPDOWNMENU_MENU_LEVEL = 1;
-- Current value of the open menu
local MSA_DROPDOWNMENU_MENU_VALUE = nil;
-- Time to wait to hide the menu
local MSA_DROPDOWNMENU_SHOW_TIME = 2;
-- Default dropdown text height
local MSA_DROPDOWNMENU_DEFAULT_TEXT_HEIGHT = nil;
-- List of open menus
local MSA_OPEN_DROPDOWNMENUS = {};
